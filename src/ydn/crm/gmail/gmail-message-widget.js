...
/**
 * @fileoverview Gmail message activity widget.
 *
 */


goog.provide('ydn.crm.ui.GmailWidget');
...
/**
 * Gmail message activity widget.
 * @param {ydn.crm.sugarcrm.model.Sugar} sugar
 * @param {ydn.crm.sugarcrm.ui.ContextSugarPanel=} opt_parent
 * @constructor
 * @struct
 */
ydn.crm.ui.GmailWidget = function(sugar, opt_parent) {
  goog.base(this);
  this.setModel(sugar);
  /**
   * @protected
   * @type {?ydn.crm.sugarcrm.ui.ContextSugarPanel}
   */
 ...
 */
ydn.crm.ui.GmailWidget.prototype.logger =
    goog.log.getLogger('ydn.crm.ui.GmailWidget');
 ...
 * @override
 */
ydn.crm.ui.GmailWidget.prototype.getModel;


/**
 * @define {boolean} debug flag.
 */
ydn.crm.ui.GmailWidget.DEBUG = false;
 ...
 * @type {string}
 */
ydn.crm.ui.GmailWidget.CSS_CLASS = 'gmail-cmd-panel';


/** @return {string} */
ydn.crm.ui.GmailWidget.prototype.getCssClass = function() {
  return ydn.crm.ui.GmailWidget.CSS_CLASS;
};
 ...
 * document.
 */
ydn.crm.ui.GmailWidget.prototype.isFree = function() {
 ...
 * @inheritDoc
 */
ydn.crm.ui.GmailWidget.prototype.createDom = function() {
 ...
 */
ydn.crm.ui.GmailWidget.prototype.getSugarDomainName = function() {
 ...
 */
ydn.crm.ui.GmailWidget.messageId2GmailLink = function(gmail, id) {
 ...
 */
ydn.crm.ui.GmailWidget.prototype.setViewLink = function(obj) {
  var link = this.getModel().getRecordViewLink(
      ydn.crm.sugarcrm.ModuleName.EMAILS, obj['id']);
  /*
   var message_id = obj['message_id'];
  var gmail = ydn.crm.ui.UserSetting.getInstance().getLoginEmail();
   var mail_id = obj['mailbox_id'];
  if (mail_id == gmail) {
    link = ydn.crm.ui.GmailWidget.messageId2GmailLink(gmail, message_id);
  }
  */
 ...
 * Set as archive link
 */
ydn.crm.ui.GmailWidget.prototype.setArchiveLink = function() {
  this.a_archive_.setLink('Archive', ydn.crm.ui.GmailWidget.HREF_ARCHIVE);
  var ele = this.a_archive_.getElement();
 ...
 * @private
 */
ydn.crm.ui.GmailWidget.prototype.updateLabel_ = function() {
  // run in next thread.
  var me = this;
  me.a_archive_.setLink('.');
  setTimeout(function() {
    me.a_archive_.setLink('..');
    var info = ydn.crm.ui.GmailWidget.gatherEmailInfo(me.getElement());
    if (info.message_id) {
      me.a_archive_.setLink('...');
      var q = {
      ...
      me.getModel().send(ydn.crm.Ch.SReq.QUERY, [q]).addCallbacks(function(arr) {
        if (ydn.crm.ui.GmailWidget.DEBUG) {
 ...
 * @inheritDoc
 */
ydn.crm.ui.GmailWidget.prototype.enterDocument = function() {
 ...
 * ydn.crm.ui.GmailWidget.gatherEmailInfo(el)
 * </pre>
 * @param {Element} el An element under message heading node.
 * @return {?ydn.crm.EmailInfo}
 */
ydn.crm.ui.GmailWidget.gatherEmailInfo = function(el) {
  var from_addr = '';
  var to_addrs = '';
  var date_sent;
  var html = '';
 ...
 * @type {string}
 */
ydn.crm.ui.GmailWidget.HREF_ARCHIVE = '#archive';


/**
 * @param {Event} e
 */
ydn.crm.ui.GmailWidget.prototype.handleArchiveClick = function(e) {
  if (goog.string.endsWith(e.target.href, ydn.crm.ui.GmailWidget.HREF_ARCHIVE)) {
    e.preventDefault();
    ...
    var info = ydn.crm.ui.GmailWidget.gatherEmailInfo(this.getElement());
    if (ydn.crm.ui.GmailWidget.DEBUG) {
