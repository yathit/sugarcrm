...
goog.provide('ydn.crm.su.ui.group.LazyGroupRenderer');
 ...
 */
ydn.crm.su.ui.group.LazyGroupRenderer = function() {
  goog.base(this);
};
goog.inherits(ydn.crm.su.ui.group.LazyGroupRenderer, ydn.crm.su.ui.group.GroupRenderer);
goog.addSingletonGetter(ydn.crm.su.ui.group.LazyGroupRenderer);


/**
 * @define {boolean} debug flag.
 */
ydn.crm.su.ui.group.LazyGroupRenderer.DEBUG = false;


/** @return {string} */
ydn.crm.su.ui.group.LazyGroupRenderer.prototype.getCssClass = function() {
 ...
 * @inheritDoc
 */
ydn.crm.su.ui.group.LazyGroupRenderer.prototype.createDom = function(ctrl) {
 ...
 * @inheritDoc
 */
ydn.crm.su.ui.group.LazyGroupRenderer.prototype.refresh = function(ctrl) {
  /**
   * @type {ydn.crm.su.model.Group}
   */
  var model = ctrl.getModel();
  ...
  for (var i = 0; i < ctrl.getChildCount(); i++) {
    ...
    if (ydn.crm.su.ui.group.LazyGroupRenderer.DEBUG && !child) {
