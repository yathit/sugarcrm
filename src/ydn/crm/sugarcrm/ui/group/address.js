 ...
 * @protected
 */
ydn.crm.sugarcrm.ui.group.Address.prototype.getActiveFieldValue = function(name) {
 ...
 * @param {string} value
 */
ydn.crm.sugarcrm.ui.group.Address.prototype.setPatchFieldValue = function(name, value) {
  if (!this.patches_) {
    this.patches_ = {};
  }
 ...
 * @inheritDoc
 */
ydn.crm.sugarcrm.ui.group.Address.prototype.getTemplateData = function() {
