...
goog.provide('ydn.crm.sugarcrm.ui.activity.EventType');
 ...
 */
ydn.crm.sugarcrm.ui.activity.NewRecordEvent = function(m_name, event_target) {
  goog.base(this, ydn.crm.sugarcrm.ui.activity.EventType.NEW_RECORD,
      event_target);
...
goog.inherits(ydn.crm.sugarcrm.ui.activity.NewRecordEvent, goog.events.Event);
